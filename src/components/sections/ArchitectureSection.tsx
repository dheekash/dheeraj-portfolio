...
const stages = [
  ...
  { name: "Executive Reporting", tech: "Power BI · Zebra BI · paginated reports", note: "Decision-grade interfaces" },
...
/**
 * Scrollytelling architecture: a center spine fills as you scroll while
 * stages alternate left/right of it — a flow diagram, not a list.
 */
