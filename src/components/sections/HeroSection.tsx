          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-border bg-card hover:bg-muted text-sm font-semibold text-foreground transition-colors group"
              >
                View Portfolio Deck{" "}
